        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item">Add Intern</div>
                </div>
            </div>
...
@push('scripts')
    ...
    document.getElementById('joining_date').addEventListener('change', function() {
        ...
        if (!isNaN(joiningDate.getTime())) {
            // Random months between 3–6
            let randomMonths = Math.floor(Math.random() * 4) + 3; 

            // Add random months
            joiningDate.setMonth(joiningDate.getMonth() + randomMonths);
            ...
            document.getElementById('ending_date').value = `${year}-${month}-${day}`;
        }
    });
</script>
