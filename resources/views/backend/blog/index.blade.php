                                    ...
                                    <tbody>
                                        @foreach ($blogs as $index => $blog)
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($blog->thumbnail)
                                                        <img src="{{ asset($blog->thumbnail) }}" width="60px" height="40px">
                                                    @else
                                                ...
                                                <td>{{ $blog->author ?? $blog->user->name ?? 'Admin' }}</td>
                                                <td>
                                                    {!! implode(' ', array_slice(explode(' ', $blog->description), 0, 17)) !!}...
                                                </td>
                                                <td class="d-flex">
                                                    <a href="{{ route('blog.show', $blog->id) }}" class="btn btn-info btn-action btn-sm mr-1"
                                                        data-toggle="tooltip" title="View"><i class="fa-solid fa-eye"></i></a>
                                                    <a href="{{ route('blog.edit', $blog->id) }}" class="btn btn-primary btn-action btn-sm mr-1"
