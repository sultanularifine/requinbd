                            ...
                            <form action="{{ route('sessions.update', $session->id) }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="mode" id="mode" class="form-control" required>
                                        <option value="Free" {{ old('mode', $session->mode) == 'Free' ? 'selected' : '' }}>Free</option>
                                        <option value="Paid" {{ old('mode', $session->mode) == 'Paid' ? 'selected' : '' }}>Paid</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="platform" id="platform" class="form-control" required>
                                        ...
                                        <option value="On-site" {{ old('platform', $session->platform) == 'On-site' ? 'selected' : '' }}>On-site</option>
                                    </select>
                                </div>
